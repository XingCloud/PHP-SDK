...
function submit(){
    ...
    params['data'] = data;
    var query = 'http://' + addr + '/' + api + '?format=' + format;
    if(method!=2){
        	...
        	<td valign="top">
        		<table border="0" cellpadding="0" cellspacing="0">
        			<tbody>
						<tr>
        				<td>
							<input type="hidden" name="api_source" id="api_source" value="<?php echo $_GET['api']?>" />
        				...
        				<td>
							<table class="parameters" width="500" border="0">
        						...
        						<tr>
        							...
        							<td><input type="text" id="info_value_1" name="info_value_1" value="xxx" size="30"></td>
        						...
        						<tr>
        							...
        							<td><input type="text" id="info_value_2" name="info_value_2" value="xxx" size="30"></td>
        						...
        						<tr>
        							...
        							<td><input type="text" id="info_value_3" name="info_value_3" value="xxx" size="30"></td>
